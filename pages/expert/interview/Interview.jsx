...
export default function Interview(props) {
  ...
  return (
    <div className={styles.interview}>
      ...
      <section className="d-flex flex-wrap px-interview mt-5">
        <div className="col-8 d-flex flex-column pe-5">
          <Image
            alt="banner"
        ...
        <div className="col-4 d-flex flex-column justify-content-between">
          ...
          <div className="position-relative">
            <div className={styles.interview_decor}>
              <p>
                Theo ông Đậu Minh Nhật, giai đoạn tiền IPO có vai trò quan trọng
                với các doanh nghiệp, nhất là trong bối cảnh cạnh tranh ngày
                càng lớn trên thế giới. Với hơn 10 năm kinh nghiệm làm việc với
                các startup và SMEs, là chuyên gia đào tạo cơ chế vốn tại Việt
                Nam, ông Minh Nhật sẽ chia sẻ thêm về sự ra đời của quỹ đầu tư
                Aura Capital cũng như kinh nghiệm IPO cho các doanh nghiệp SMEs.
              </p>
            </div>
          </div>
        </div>
