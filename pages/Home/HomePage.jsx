  ...
  return (
    <MainLayout>
      <div className={styles.homepage}>
        <div className={styles.banner + " " + "d-flex justify-content-center"}>
          <Image src={BannerTop} alt="banner" height={452} width={1115} />
        </div>
            ...
            >
              {news.slice(1, 5).map((item, index) => (
                <div key={index}>
                  ...
                  {index < 3 && (
                    <hr className="my-3" style={{ height: "0.5px" }} />
                  )}
                </div>
              ))}
            </div>
        ...
        <div className={styles.news_ipo}>
          ...
          <div className="row" style={{ marginTop: "20px" }}>
            ...
            >
              ...
              ></div>
              <Image width={244} height={470} src={BannerLeft1} alt="banner" />
            </div>
          </div>
          <hr
            style={{
          ...
          <div className="row d-flex justify-content-center">
                ...
                news.slice(0, 6).map((item, index) => (
                  <div key={index} className="row">
                    <div className="col-12 col-lg-6">
                      <div
                        className={
                          styles.box_content_news + " " + "text-align-center"
                        }
                      >
                        <h4
                          style={{ fontSize: "20px" }}
                    ...
                    <div className="col-12 col-lg-6 d-flex flex-md-row flex-column align-items-center mb-3 mb-lg-0 flex-lg-none justify-content-end p-0">
                      <div className={"row px-lg-0 d-lg-flex px-2"}>
            ...
            <div
              className={
                styles.box_banner_right + " " + "col-3 d-none d-lg-block"
              }
            >
              <div
            ...
            {news.length > 0 &&
              news.slice(0, 3).map((item, index) => (
                ...
                >
                  ...
                  >
                    {index === 0 && (
                      <span onClick={() => router.push("/library/case-study")}>
                  ...
                  >
                    <div
                      className={
                        styles.box_image + " " + "d-flex justify-content-center"
                      }
                    >
                      <Image
                        height={191}
        ...
        <p className="col decor"></p>
          ...
          <div className={styles.box_content + " " + "row"}>
            <div
              className={
                styles.box_video + " " + "col-12 mb-3 mb-lg-0 col-lg-8 pe-md-2"
              }
            >
              <div className="h-100" style={{ background: "gray" }}>
                {/* <iframe
									width="100%"
									height="100%"
									src={gallery[0]?.url}
            ...
            <div
              className={styles.box_content_media + " " + "col-12 col-lg-4 p-0"}
                  ...
                  {gallery.slice(1, 8).map((item, index) => (
                    <div key={index}>
                      <div className={styles.item_library + " " + "row"}>
                        <div className={styles.video + " " + "p-0 col-6"}>
                          <div>
                            {/* <iframe
                  ...
                  <div key={index}>
                    ...
                    >
                      <p
                        ...
                        className={styles.homepage_title_slider}
                      >
                        {item.title}
                      </p>
                      <p className={styles.homepage_content_slider}>
                        {item.mieu_ta_ngan}
                      </p>
                    </div>
                  </div>
