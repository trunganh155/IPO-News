      ...
      <div className={styles.homepage}>
        ...
        <div className={styles.news_ipo}>
          ...
          <div className="row" style={{ marginTop: "20px" }}>
            ...
            >
              ...
              ></div>
              <Image width={244} height={713} src={BannerRight} alt="banner" />
            </div>
          </div>
          <hr
            style={{
                ...
                news.slice(0, 6).map((item, index) => (
                  <div key={index} className="row">
                    ...
                    <div className="col-12 col-md-5 col-lg-4 d-flex flex-md-row flex-column align-items-center mb-3 mb-lg-0 flex-lg-none justify-content-end">
                      <div style={{ marginRight: "22px" }} className="d-flex">
                        <Image
                          width={418}
                          height={229}
                          loader={({ src }) =>
        ...
        <div className={styles.experts}>
          ...
          <div className="row justify-content-center justify-content-lg-space-around">
            <div className={styles.list_expert} style={{ padding: "0 20px" }}>
              ...
              <Slider {...settings}>
                {news.slice(1, 8).map((item, index) => (
                  <div key={index}>
                    ...
                    >
                      <p className={styles.homepage_title_slider}>
                        {item.title}
                      </p>
