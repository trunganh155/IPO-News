				...
				<div className={styles.knowledge}>
					...
					<div className="row">
						...
						>
							...
							<span>IPO là gì?</span>
							<h5>
								IPO (Initial Public Offering), có nghĩa là phát
						...
						<div className="col-12 col-lg-9">
							<div className="text-align-center p-4">
								<h4>
									...
									adipiscing elit, sed do eiusmod tempor
									incididunt ut labore et dolore magna aliqua.
									Nisl tincidunt eget nullam non. Quis
								...
								<h5>
									...
									malesuada proin. Neque convallis a cras
									semper auctor. Libero id faucibus nisl
									tincidunt eget. Leo a diam sollicitudin
									tempor id. A lacus vestibulum sed arcu non
									odio euismod lacinia. In tellus integer
									feugiat scelerisque.
								</h5>
							</div>
						</div>
					...
					<div className="row justify-content-center justify-content-lg-space-around">
						<div className="col-12 col-sm-8 col-lg-4">
							...
							>
								...
								<h3>
									Hành Trình Getfit IPO – Phát Triển Thương
									Hiệu Gym Việt
								</h3>
								<h5>
									Hành trình đưa một thương hiệu Gym Việt lên
									sàn IPO thành công vang đội. Những khó khăn
									và bài học được rút ra. Phân tích Getfit đã
									làm để đứng vững qua những giai đoạn khủng
									hoảng của đất nước.
								</h5>
							</div>
						</div>
						<div className="col-12 col-sm-8 col-lg-4">
							...
							>
								...
								<h3>
									So găng Vietcombank và Techcombank: Chiến
									lược và lợi thế khác biệt trong bức tranh
									kinh doanh 6 tháng đầu năm 2022
								</h3>
							</div>
						</div>
						<div className="col-12 col-sm-8 col-lg-4">
							...
							>
								...
								<h5>
									Tài liệu chi tiết tìm hiểu – phân tích cách
									Richard Branson – nhà tỷ phú người Anh làm
									thế nào có thể quản lý hơn 400 doanh nghiệp
									cũng một lúc.
								</h5>
							</div>
						</div>
