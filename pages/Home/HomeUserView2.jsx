...
function HomeUserView2(props) {
	...
	return (
		<div className={styles.homeuser_view2 + " " + "row"}>
			<div
				className={styles.box_profile + " " + "p-0 pe-2"}
			>
				...
				<div
					className={
						styles.profile_detail + " " + "col-12 text-center"
					}
				>
					<h3>
						Thông tin thành viên: <span>VÕ TRỌNG KHANG</span>
					</h3>
					<h3>
			...
			<div className={styles.box_content + " " + "col-7"}>
				<div className={styles.tag_news}>
					{LISTTAGNEWS.map((item, index) => {
						return (
							<span
								className={
									isTagNews === item.id ? styles.active : ""
								}
				...
				<div className={styles.list_news}>
					{news.map((item, index) => {
						return (
							<div
								className={styles.item_news + " " + "row"}
								key={index}
							>
								<h3
