    ...
    >
      <Container fluid className={styles.wrapper + " " + "p-0"}>
        <div className="w-100">
          ...
          <div className={styles.header_mid + " " + "row px-2 my-2 my-md-5"}>
          ...
          <div
            ...
            className={
              styles.menu_list + " " + "d-flex justify-content-xl-center"
            }
          >
                  ...
                  >
                    ...
                    <ul className={styles.dropdown_menu}>
                      {item.listTag.map((subItem, subIndex) => {
                        return (
                          <li key={subIndex} className={styles.dropdown_item_1}>
                            <div onClick={() => router.push(subItem.link)}>
                              {subItem.tag}
                            </div>
                          </li>
                        );
