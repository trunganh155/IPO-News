  ...
  return (
    <footer className={styles.footer_black}>
      <div className={styles.box_footer + " " + "container py-5"}>
        ...
        <div
          className={styles.box_top_desktop + " " + "justify-content-between"}
        >
          {HeaderData.map((item, index) => {
            return (
        ...
        <div className={styles.box_bottom + " " + "row"}>
          <div
            className={
              styles.bottom_left + " " + "col-12 col-lg-6 mb-3 mb-lg-0"
            }
          >
            <h5>Liên hệ</h5>
            <div
            ...
            <h6 className="mt-2">
              Số 1-3 đường D4, Khu Him Lam Kênh Tẻ, Phường Tân Hưng, Quận 7,
              TPHCM
            </h6>
          ...
          >
            <div className={styles.contain}>
              ...
              ></div>
              <span>
                Đăng kí để không bỏ lỡ những thông tin mới nhất từ FOS Group
              </span>
              <div>
